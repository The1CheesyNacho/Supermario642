// Red_koopa (Small Red_koopa, Big Red_koopa [Red_koopa the Quick])
...
// This light approximates the pink shorts that Red_koopas have, but is not exact
...
// 0x06003648
ALIGNED8 static const Texture red_koopa_seg6_texture_06003E48[] = {
#include "actors/red_koopa/koopa_shell_front_top.rgba16.inc.c"
};

// 0x06002648
ALIGNED8 static const Texture red_koopa_seg6_texture_06002648[] = {
#include "actors/red_koopa/koopa_shell_front.rgba16.inc.c"
};

// 0x06002E48
ALIGNED8 static const Texture red_koopa_seg6_texture_06002E48[] = {
#include "actors/red_koopa/koopa_shell_back.rgba16.inc.c"
};

// 0x06003648
ALIGNED8 static const Texture red_koopa_seg6_texture_06003648[] = {
#include "actors/red_koopa/koopa_shoe.rgba16.inc.c"
};


// 0x06004648
ALIGNED8 static const Texture red_koopa_seg6_texture_06004648[] = {
#include "actors/red_koopa/koopa_eyes_open.rgba16.inc.c"
};

// 0x06004E48
ALIGNED8 static const Texture red_koopa_seg6_texture_06004E48[] = {
#include "actors/red_koopa/koopa_eyes_closed.rgba16.inc.c"
};

// 0x06005648
ALIGNED8 static const Texture red_koopa_seg6_texture_06005648[] = {
#include "actors/red_koopa/koopa_eye_border.rgba16.inc.c"
};

// 0x06005E48
ALIGNED8 static const Texture red_koopa_seg6_texture_06005E48[] = {
#include "actors/red_koopa/koopa_nostrils.rgba16.inc.c"
};
...
// 0x06006E78
static const Vtx red_koopa_seg6_vertex_06006E78[] = {
...
// 0x06006F08
static const Vtx red_koopa_seg6_vertex_06006F08[] = {
...
// 0x06006FF8
static const Vtx red_koopa_seg6_vertex_06006FF8[] = {
    {{{     0,     52,      0}, 0, {   460,   4212}, {0x99, 0x49, 0x09, 0xff}}},
...
// 0x060070F8
static const Vtx red_koopa_seg6_vertex_060070F8[] = {
    {{{    54,      2,    -87}, 0, {  1264,   2416}, {0xf1, 0x01, 0x82, 0xff}}},
    {{{    23,    -24,    -59}, 0, {  1012,   3160}, {0xac, 0xcc, 0xb2, 0xff}}},
    {{{    15,     22,    -64}, 0, {  1060,   3604}, {0xae, 0x1d, 0xa5, 0xff}}},
...
// 0x060071E8
static const Vtx red_koopa_seg6_vertex_060071E8[] = {
    {{{    43,    -44,     54}, 0, {   -46,   2612}, {0xe6, 0xa4, 0x52, 0xff}}},
...
// 0x06007268
static const Vtx red_koopa_seg6_vertex_06007268[] = {
...
// 0x06007358
static const Vtx red_koopa_seg6_vertex_06007358[] = {
    {{{   111,      2,     52}, 0, {  1908,   -278}, {0x39, 0x0e, 0x70, 0xff}}},
...
// 0x06007458
static const Vtx red_koopa_seg6_vertex_06007458[] = {
...
// 0x06007488
static const Vtx red_koopa_seg6_vertex_06007488[] = {
...
// 0x060074B8
static const Vtx red_koopa_seg6_vertex_060074B8[] = {
...
// 0x060075B8
static const Vtx red_koopa_seg6_vertex_060075B8[] = {
    {{{   111,      2,    -51}, 0, {     0,      0}, {0x39, 0x0d, 0x90, 0xff}}},
...
const Gfx red_koopa_seg6_dl_06007658[] = {
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_06006E78, 9, 0),
...
const Gfx red_koopa_seg6_dl_060076B0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06005648),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(red_koopa_seg6_vertex_06006F08, 15, 0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06006FF8, 16, 0),
...
const Gfx red_koopa_seg6_dl_06007850[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06005E48),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(red_koopa_seg6_vertex_06007268, 15, 0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06007358, 16, 0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06007458, 3, 0),
    gsSP1Triangle( 0,  1,  2, 0x0),
    gsSPEndDisplayList(),
};

// 0x06007970 - 0x06007A60
const Gfx red_koopa_seg6_dl_06007970[] = {
    gsSPLightColor(LIGHT_1, 0xce1635ff),
    gsSPLightColor(LIGHT_2, 0x670b1aff),
    gsSPVertex(red_koopa_seg6_vertex_06007488, 3, 0),
    gsSP1Triangle( 0,  1,  2, 0x0),
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_060074B8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_060075B8, 10, 0),
...
const Gfx red_koopa_seg6_dl_06007A60[] = {
    gsDPPipeSync(),
...
const Gfx red_koopa_seg6_dl_06007AA0[] = {
    gsSPDisplayList(red_koopa_seg6_dl_06007658),
    gsSPDisplayList(red_koopa_seg6_dl_060076B0),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 6, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(red_koopa_seg6_dl_06007850),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(red_koopa_seg6_dl_06007970),
    gsSPEndDisplayList(),
};

// 0x06007AF8 - 0x06007B20
const Gfx red_koopa_seg6_dl_06007AF8[] = {
    gsSPDisplayList(red_koopa_seg6_dl_06007A60),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06004648),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPBranchList(red_koopa_seg6_dl_06007AA0),
};

// 0x06007B20 - 0x06007B48
const Gfx red_koopa_seg6_dl_06007B20[] = {
    gsSPDisplayList(red_koopa_seg6_dl_06007A60),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06004E48),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPBranchList(red_koopa_seg6_dl_06007AA0),
};
...
// 0x06007B78
static const Vtx red_koopa_seg6_vertex_06007B78[] = {
...
// 0x06007C18
static const Vtx red_koopa_seg6_vertex_06007C18[] = {
...
// 0x06007CF8
static const Vtx red_koopa_seg6_vertex_06007CF8[] = {
...
// 0x06007D48
static const Vtx red_koopa_seg6_vertex_06007D48[] = {
...
// 0x06007E38
static const Vtx red_koopa_seg6_vertex_06007E38[] = {
    {{{  -107,      5,      0}, 0, {     0,      0}, {0x88, 0xd8, 0x00, 0xff}}},
...
// 0x06007F28
static const Vtx red_koopa_seg6_vertex_06007F28[] = {
    {{{   -68,     38,     56}, 0, {     0,      0}, {0xab, 0x53, 0x2a, 0xff}}},
    {{{   -68,     17,     86}, 0, {     0,      0}, {0x9d, 0x12, 0x4c, 0xff}}},
...
const Gfx red_koopa_seg6_dl_06007FB8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06002E48),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_06007B78, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
...
const Gfx red_koopa_seg6_dl_06008050[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06002648),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(red_koopa_seg6_vertex_06007C18, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
...
const Gfx red_koopa_seg6_dl_060080F8[] = {
    gsSPLightColor(LIGHT_1, 0xe0ae00ff),
    gsSPLightColor(LIGHT_2, 0x705700ff),
    gsSPVertex(red_koopa_seg6_vertex_06007CF8, 5, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
    gsSP1Triangle( 2,  4,  3, 0x0),
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_06007D48, 15, 0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06007E38, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06007F28, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
...
const Gfx red_koopa_seg6_dl_06008250[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(red_koopa_seg6_dl_06007FB8),
    gsSPDisplayList(red_koopa_seg6_dl_06008050),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(red_koopa_seg6_dl_060080F8),
    gsSPEndDisplayList(),
};
...
// 0x060082F0
static const Vtx red_koopa_seg6_vertex_060082F0[] = {
...
// 0x060083F0
static const Vtx red_koopa_seg6_vertex_060083F0[] = {
...
// 0x06008470
static const Vtx red_koopa_seg6_vertex_06008470[] = {
...
const Gfx red_koopa_seg6_dl_06008530[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06003648),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_060082F0, 16, 0),
...
const Gfx red_koopa_seg6_dl_060085E8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06003E48),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(red_koopa_seg6_vertex_060083F0, 8, 0),
...
const Gfx red_koopa_seg6_dl_06008640[] = {
    gsSPLightColor(LIGHT_1, 0xC52700ff),
    gsSPLightColor(LIGHT_2, 0x511000ff),
    gsSPVertex(red_koopa_seg6_vertex_06008470, 12, 0),
...
const Gfx red_koopa_seg6_dl_060086D0[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(red_koopa_seg6_dl_06008530),
    gsSPDisplayList(red_koopa_seg6_dl_060085E8),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(red_koopa_seg6_dl_06008640),
    gsSPEndDisplayList(),
};
...
// 0x06008770
static const Vtx red_koopa_seg6_vertex_06008770[] = {
...
// 0x06008870
static const Vtx red_koopa_seg6_vertex_06008870[] = {
...
// 0x060088F0
static const Vtx red_koopa_seg6_vertex_060088F0[] = {
...
const Gfx red_koopa_seg6_dl_060089B0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06003648),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_06008770, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  1,  3,  2, 0x0),
    gsSP2Triangles( 1,  4,  3, 0x0,  4,  5,  3, 0x0),
    gsSP2Triangles( 0,  2,  6, 0x0,  4,  7,  5, 0x0),
    gsSP2Triangles( 8,  5,  7, 0x0,  8,  7,  9, 0x0),
...
const Gfx red_koopa_seg6_dl_06008A68[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, red_koopa_seg6_texture_06003E48),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(red_koopa_seg6_vertex_06008870, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  4, 0x0),
    gsSP2Triangles( 2,  4,  0, 0x0,  0,  5,  1, 0x0),
    gsSP2Triangles( 5,  6,  1, 0x0,  5,  7,  6, 0x0),
    gsSPEndDisplayList(),
...
const Gfx red_koopa_seg6_dl_06008AC0[] = {
    gsSPLightColor(LIGHT_1, 0xC52700ff),
    gsSPLightColor(LIGHT_2, 0x511000ff),
    gsSPVertex(red_koopa_seg6_vertex_060088F0, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
...
const Gfx red_koopa_seg6_dl_06008B50[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(red_koopa_seg6_dl_060089B0),
    gsSPDisplayList(red_koopa_seg6_dl_06008A68),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPDisplayList(red_koopa_seg6_dl_06008AC0),
    gsSPEndDisplayList(),
};

// 0x06008BC0
static const Vtx red_koopa_seg6_vertex_06008BC0[] = {
...
// 0x06008CC0
static const Vtx red_koopa_seg6_vertex_06008CC0[] = {
...
// 0x06008DA0
static const Vtx red_koopa_seg6_vertex_06008DA0[] = {
    {{{    27,      6,     43}, 0, {     0,      0}, {0xe6, 0x30, 0x72, 0x00}}},
    {{{    26,     40,     17}, 0, {     0,      0}, {0xef, 0x70, 0x38, 0x00}}},
    {{{     1,     39,     11}, 0, {     0,      0}, {0xb8, 0x5a, 0x34, 0x00}}},
    {{{     1,      5,     35}, 0, {     0,      0}, {0xc3, 0x2b, 0x66, 0x00}}},
...
// 0x06008E80
static const Vtx red_koopa_seg6_vertex_06008E80[] = {
...
// 0x06008F60
static const Vtx red_koopa_seg6_vertex_06008F60[] = {
...
// 0x06009040
static const Vtx red_koopa_seg6_vertex_06009040[] = {
...
// 0x06009140
static const Vtx red_koopa_seg6_vertex_06009140[] = {
...
// 0x06009240
static const Vtx red_koopa_seg6_vertex_06009240[] = {
    {{{     1,      5,    -36}, 0, {     0,      0}, {0xc3, 0x2b, 0x9a, 0x00}}},
    {{{    26,     40,    -18}, 0, {     0,      0}, {0xef, 0x70, 0xc8, 0x00}}},
    {{{    27,      6,    -44}, 0, {     0,      0}, {0xe6, 0x30, 0x8e, 0x00}}},
    {{{    27,    -49,    -50}, 0, {     0,      0}, {0xf2, 0xdf, 0x87, 0x00}}},
...
// 0x06009340
static const Vtx red_koopa_seg6_vertex_06009340[] = {
    {{{    27,    -49,     44}, 0, {     0,      0}, {0x7f, 0x01, 0x00, 0x00}}},
    {{{    27,    -76,    -27}, 0, {     0,      0}, {0x7f, 0x01, 0x00, 0x00}}},
...
// 0x06009410
static const Vtx red_koopa_seg6_vertex_06009410[] = {
    {{{    -1,     -6,     16}, 0, {     0,      0}, {0xe3, 0xe0, 0x76, 0x00}}},
    {{{    -1,    -17,      0}, 0, {     0,      0}, {0xf0, 0x83, 0x00, 0x00}}},
    {{{    61,    -25,      0}, 0, {     0,      0}, {0xf0, 0x83, 0x00, 0x00}}},
    {{{    61,     -6,     29}, 0, {     0,      0}, {0xe3, 0xe0, 0x76, 0x00}}},
...
// 0x060094F0
static const Vtx red_koopa_seg6_vertex_060094F0[] = {
...
// 0x060095D0
static const Vtx red_koopa_seg6_vertex_060095D0[] = {
...
// 0x060096C0
static const Vtx red_koopa_seg6_vertex_060096C0[] = {
...
// 0x060097B0
static const Vtx red_koopa_seg6_vertex_060097B0[] = {
    {{{    14,     15,    -37}, 0, {     0,      0}, {0xdb, 0x2b, 0x8f, 0x00}}},
    {{{    20,     35,     -2}, 0, {     0,      0}, {0x15, 0x7d, 0x00, 0x00}}},
    {{{    44,      5,    -22}, 0, {     0,      0}, {0x1d, 0x74, 0xd8, 0x00}}},
    {{{    67,    -22,     20}, 0, {     0,      0}, {0x68, 0xdf, 0x3f, 0x00}}},
...
// 0x060098A0
static const Vtx red_koopa_seg6_vertex_060098A0[] = {
    {{{    14,     15,     33}, 0, {     0,      0}, {0xdb, 0x2b, 0x71, 0x00}}},
    {{{    -6,     24,     -2}, 0, {     0,      0}, {0xa1, 0x53, 0x00, 0x00}}},
    {{{    -6,    -18,     19}, 0, {     0,      0}, {0x96, 0xe3, 0x3e, 0x00}}},
    {{{    14,     15,    -37}, 0, {     0,      0}, {0xdb, 0x2b, 0x8f, 0x00}}},
...
// 0x060099A0
static const Vtx red_koopa_seg6_vertex_060099A0[] = {
    {{{    44,     -8,     38}, 0, {     0,      0}, {0x26, 0x15, 0x77, 0x00}}},
    {{{    30,    -22,     33}, 0, {     0,      0}, {0x05, 0xcc, 0x73, 0x00}}},
    {{{    48,    -41,     18}, 0, {     0,      0}, {0x23, 0x99, 0x40, 0x00}}},
    {{{    44,      5,     18}, 0, {     0,      0}, {0x1d, 0x74, 0x28, 0x00}}},
...
// 0x06009A30
static const Vtx red_koopa_seg6_vertex_06009A30[] = {
...
// 0x06009AD0
static const Vtx red_koopa_seg6_vertex_06009AD0[] = {
...
// 0x06009BB0
static const Vtx red_koopa_seg6_vertex_06009BB0[] = {
...
// 0x06009CA0
static const Vtx red_koopa_seg6_vertex_06009CA0[] = {
    {{{    -6,    -18,     23}, 0, {     0,      0}, {0x96, 0xe3, 0x3e, 0x00}}},
    {{{    14,    -41,     19}, 0, {     0,      0}, {0xdc, 0x98, 0x3e, 0x00}}},
...
// 0x06009D90
static const Vtx red_koopa_seg6_vertex_06009D90[] = {
    {{{    44,      5,     22}, 0, {     0,      0}, {0x1d, 0x74, 0x28, 0x00}}},
    {{{    20,     35,      2}, 0, {     0,      0}, {0x15, 0x7d, 0x00, 0x00}}},
    {{{    14,     15,     37}, 0, {     0,      0}, {0xdb, 0x2b, 0x71, 0x00}}},
    {{{    67,    -22,     24}, 0, {     0,      0}, {0x68, 0xdf, 0x3f, 0x00}}},
...
// 0x06009E80
static const Vtx red_koopa_seg6_vertex_06009E80[] = {
    {{{    -6,    -18,    -19}, 0, {     0,      0}, {0x96, 0xe3, 0xc2, 0x00}}},
    {{{    -6,     24,      2}, 0, {     0,      0}, {0xa1, 0x53, 0x00, 0x00}}},
    {{{    14,     15,    -33}, 0, {     0,      0}, {0xdb, 0x2b, 0x8f, 0x00}}},
    {{{    -6,    -18,     23}, 0, {     0,      0}, {0x96, 0xe3, 0x3e, 0x00}}},
...
// 0x06009F80
static const Vtx red_koopa_seg6_vertex_06009F80[] = {
    {{{    48,    -41,    -18}, 0, {     0,      0}, {0x23, 0x99, 0xc0, 0x00}}},
    {{{    30,    -22,    -33}, 0, {     0,      0}, {0x05, 0xcc, 0x8d, 0x00}}},
    {{{    44,     -8,    -38}, 0, {     0,      0}, {0x26, 0x15, 0x89, 0x00}}},
    {{{    14,     15,    -33}, 0, {     0,      0}, {0xdb, 0x2b, 0x8f, 0x00}}},
...
// 0x0600A010
static const Vtx red_koopa_seg6_vertex_0600A010[] = {
...
// 0x0600A0B0
static const Vtx red_koopa_seg6_vertex_0600A0B0[] = {
...
// 0x0600A1A0
static const Vtx red_koopa_seg6_vertex_0600A1A0[] = {
...
// 0x0600A2A0
static const Vtx red_koopa_seg6_vertex_0600A2A0[] = {
...
// 0x0600A3A0
static const Vtx red_koopa_seg6_vertex_0600A3A0[] = {
...
// 0x0600A4A0
static const Vtx red_koopa_seg6_vertex_0600A4A0[] = {
    {{{    10,     49,    -36}, 0, {     0,      0}, {0xac, 0x42, 0xbd, 0x00}}},
    {{{    63,     40,    -62}, 0, {     0,      0}, {0x17, 0x3d, 0x94, 0x00}}},
    {{{    14,     21,    -64}, 0, {     0,      0}, {0xaf, 0x1e, 0xa4, 0x00}}},
    {{{    75,    -16,     81}, 0, {     0,      0}, {0x2c, 0xe3, 0x73, 0x00}}},
...
// 0x0600A5A0
static const Vtx red_koopa_seg6_vertex_0600A5A0[] = {
    {{{    91,     82,    -51}, 0, {     0,      0}, {0x14, 0x35, 0x8f, 0x00}}},
    {{{   139,     71,    -49}, 0, {     0,      0}, {0x46, 0x33, 0xa4, 0x00}}},
    {{{    98,     22,    -60}, 0, {     0,      0}, {0x2f, 0x0e, 0x8c, 0x00}}},
    {{{    53,      2,    -86}, 0, {     0,      0}, {0xf2, 0x02, 0x82, 0x00}}},
...
// 0x0600A690
static const Vtx red_koopa_seg6_vertex_0600A690[] = {
    {{{    42,    -44,     54}, 0, {     0,      0}, {0xe4, 0xa5, 0x52, 0x00}}},
    {{{    68,    -65,     17}, 0, {     0,      0}, {0xe6, 0x8b, 0x28, 0x00}}},
    {{{   101,    -44,     53}, 0, {     0,      0}, {0xf4, 0xae, 0x60, 0x00}}},
    {{{    53,      2,     86}, 0, {     0,      0}, {0xf2, 0x02, 0x7e, 0x00}}},
...
// 0x0600A790
static const Vtx red_koopa_seg6_vertex_0600A790[] = {
    {{{    75,    -16,    -82}, 0, {     0,      0}, {0x2c, 0xe3, 0x8d, 0x00}}},
    {{{    98,     22,    -60}, 0, {     0,      0}, {0x2f, 0x0e, 0x8c, 0x00}}},
...
// 0x0600A890
static const Vtx red_koopa_seg6_vertex_0600A890[] = {
    {{{    91,     82,    -51}, 0, {     0,      0}, {0x84, 0x19, 0x00, 0x00}}},
...
// 0x0600A990
static const Vtx red_koopa_seg6_vertex_0600A990[] = {
    {{{   139,     71,    -49}, 0, {     0,      0}, {0x46, 0x33, 0xa4, 0x00}}},
    {{{   147,     97,      0}, 0, {     0,      0}, {0x56, 0x5d, 0x00, 0x00}}},
    {{{   168,     41,      0}, 0, {     0,      0}, {0x7e, 0xf8, 0x00, 0x00}}},
};
...
// 0x0600A9C0
static const Vtx red_koopa_seg6_vertex_0600A9C0[] = {
...
// 0x0600AAC0
static const Vtx red_koopa_seg6_vertex_0600AAC0[] = {
    {{{   119,    -30,    -63}, 0, {     0,      0}, {0xf6, 0x07, 0x82, 0x00}}},
    {{{   131,    -11,    -56}, 0, {     0,      0}, {0x41, 0x48, 0xaf, 0x00}}},
...
// 0x0600ABB0
static const Vtx red_koopa_seg6_vertex_0600ABB0[] = {
    {{{   182,    -56,     23}, 0, {     0,      0}, {0x73, 0x18, 0x2d, 0x00}}},
    {{{   182,    -56,    -23}, 0, {     0,      0}, {0x6d, 0x22, 0xc9, 0x00}}},
    {{{   137,     -5,      0}, 0, {     0,      0}, {0x56, 0x5c, 0x00, 0x00}}},
    {{{   131,    -11,     55}, 0, {     0,      0}, {0x41, 0x48, 0x51, 0x00}}},
...
// 0x0600AC90
static const Vtx red_koopa_seg6_vertex_0600AC90[] = {
...
// 0x0600AD90
static const Vtx red_koopa_seg6_vertex_0600AD90[] = {
    {{{  -109,      4,      0}, 0, {     0,      0}, {0xa8, 0xa6, 0x00, 0x00}}},
...
// 0x0600AE90
static const Vtx red_koopa_seg6_vertex_0600AE90[] = {
...
// 0x0600AF60
static const Vtx red_koopa_seg6_vertex_0600AF60[] = {
    {{{   -85,    -18,      0}, 0, {     0,      0}, {0x98, 0xb9, 0x00, 0x00}}},
...
// 0x0600B000
static const Vtx red_koopa_seg6_vertex_0600B000[] = {
...
// 0x0600B0E0
static const Vtx red_koopa_seg6_vertex_0600B0E0[] = {
...
// 0x0600B190
static const Vtx red_koopa_seg6_vertex_0600B190[] = {
...
// 0x0600B270
static const Vtx red_koopa_seg6_vertex_0600B270[] = {
...
// 0x0600B370
static const Vtx red_koopa_seg6_vertex_0600B370[] = {
    {{{    13,    -27,     35}, 0, {     0,      0}, {0x0d, 0x89, 0x29, 0xff}}},
...
// 0x0600B470
static const Vtx red_koopa_seg6_vertex_0600B470[] = {
    {{{    29,     49,     50}, 0, {     0,      0}, {0x06, 0x46, 0x69, 0xff}}},
...
// 0x0600B560
static const Vtx red_koopa_seg6_vertex_0600B560[] = {
    {{{    13,    -27,     35}, 0, {     0,      0}, {0x0d, 0x89, 0x29, 0xff}}},
    {{{    38,     -9,     69}, 0, {     0,      0}, {0x15, 0x97, 0x43, 0x00}}},
...
// 0x0600B5F0
static const Vtx red_koopa_seg6_vertex_0600B5F0[] = {
...
const Gfx red_koopa_seg6_dl_0600B6E0[] = {
    gsSPLightColor(LIGHT_1, 0xb200ff),
    gsSPLightColor(LIGHT_2, 0x5900ff),
    gsSPVertex(red_koopa_seg6_vertex_06008BC0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_06008CC0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06008DA0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9,  5, 0x0,  8,  5, 10, 0x0),
    gsSP2Triangles(11, 12,  9, 0x0, 11,  9, 13, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_06008E80, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
...
const Gfx red_koopa_seg6_dl_0600B838[] = {
    gsSPLightColor(LIGHT_1, 0xe0ae00ff),
    gsSPLightColor(LIGHT_2, 0x705700ff),
    gsSPVertex(red_koopa_seg6_vertex_06008F60, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  7,  8,  9, 0x0),
...
const Gfx red_koopa_seg6_dl_0600B8B8[] = {
    gsSPLightColor(LIGHT_1, 0xb200ff),
    gsSPLightColor(LIGHT_2, 0x5900ff),
    gsSPVertex(red_koopa_seg6_vertex_06009040, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_06009140, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_06009240, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  5,  6, 0x0,  7,  5,  8, 0x0),
    gsSP2Triangles( 7,  8,  9, 0x0, 10,  8, 11, 0x0),
    gsSP2Triangles(10, 11, 12, 0x0, 13, 14, 15, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_06009340, 13, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx red_koopa_seg6_dl_0600BA10[] = {
    gsSPLightColor(LIGHT_1, 0xe0ae00ff),
    gsSPLightColor(LIGHT_2, 0x705700ff),
    gsSPVertex(red_koopa_seg6_vertex_06009410, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles( 7,  9, 10, 0x0,  7, 10, 11, 0x0),
    gsSP2Triangles(12,  4,  6, 0x0, 12,  6, 13, 0x0),
...
const Gfx red_koopa_seg6_dl_0600BC18[] = {
    gsSPLightColor(LIGHT_1, 0xe0ae00ff),
    gsSPLightColor(LIGHT_2, 0x705700ff),
    gsSPVertex(red_koopa_seg6_vertex_06009A30, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
...
const Gfx red_koopa_seg6_dl_0600BE10[] = {
    gsSPLightColor(LIGHT_1, 0xe0ae00ff),
    gsSPLightColor(LIGHT_2, 0x705700ff),
    gsSPVertex(red_koopa_seg6_vertex_0600A010, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 1,  4,  5, 0x0,  1,  5,  2, 0x0),
    gsSP2Triangles( 4,  6,  7, 0x0,  4,  7,  5, 0x0),
    gsSP2Triangles( 6,  8,  9, 0x0,  6,  9,  7, 0x0),
...
const Gfx red_koopa_seg6_dl_0600C240[] = {
    gsSPLightColor(LIGHT_1, 0xb2b2b2ff),
    gsSPLightColor(LIGHT_2, 0x595959ff),
    gsSPVertex(red_koopa_seg6_vertex_0600AC90, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  7,  5,  4, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_0600AF60, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPLightColor(LIGHT_1, 0xe0ae00ff),
    gsSPLightColor(LIGHT_2, 0x705700ff),
    gsSPVertex(red_koopa_seg6_vertex_0600B000, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_0600B0E0, 11, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
...
const Gfx red_koopa_seg6_dl_0600C498[] = {
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(red_koopa_seg6_vertex_0600B190, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles(10, 11, 12, 0x0, 10, 12, 13, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_0600B270, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    ...
    gsSPVertex(red_koopa_seg6_vertex_0600B370, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP2Triangles( 4,  6,  5, 0x0, 12,  1, 13, 0x0),
    gsSP2Triangles(14,  9, 11, 0x0, 14, 11, 15, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_0600B470, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  7,  8,  1, 0x0),
    gsSP2Triangles( 7,  1,  0, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(red_koopa_seg6_vertex_0600B560, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP1Triangle( 6,  7,  8, 0x0),
#ifdef RED_KOOPA_KEEP_PINK_SHORTS
    gsSPLightColor(LIGHT_1, 0xde01deff),
    gsSPLightColor(LIGHT_2, 0xdec1deff),
#endif
    gsSPVertex(red_koopa_seg6_vertex_0600B5F0, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
