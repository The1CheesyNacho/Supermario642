...
// 0x08019530
ALIGNED8 static const Texture micro_goomba_seg8_texture_08019530[] = {
#include "actors/micro_goomba/goomba_body.rgba16.inc.c"
};

// 0x08019D30
ALIGNED8 static const Texture micro_goomba_seg8_texture_08019D30[] = {
#include "actors/micro_goomba/goomba_face.rgba16.inc.c"
};

// 0x0801A530
ALIGNED8 static const Texture micro_goomba_seg8_texture_0801A530[] = {
#include "actors/micro_goomba/goomba_face_blink.rgba16.inc.c"
};

#ifdef MICRO_FLOOMBAS
ALIGNED8 static const Texture micro_floomba_seg8_texture_face[] = {
#include "actors/micro_goomba/custom_floomba_face.rgba16.inc.c"
};

ALIGNED8 static const Texture micro_floomba_seg8_texture_blink[] = {
#include "actors/micro_goomba/custom_floomba_face_blink.rgba16.inc.c"
};
#endif
...
// 0x0801AD48
static const Vtx micro_goomba_seg8_vertex_0801AD48[] = {
...
// 0x0801AE38
static const Vtx micro_goomba_seg8_vertex_0801AE38[] = {
...
// 0x0801AF38
static const Vtx micro_goomba_seg8_vertex_0801AF38[] = {
    {{{   -23,    -54,   -117}, 0, { -3250,   1226}, {0xbc, 0xdc, 0x9c, 0xff}}},
...
// 0x0801B038
static const Vtx micro_goomba_seg8_vertex_0801B038[] = {
    {{{   143,     65,     69}, 0, {   906,    -78}, {0x4d, 0x51, 0x3a, 0xff}}},
    {{{    80,     98,     62}, 0, {   858,    338}, {0x1d, 0x6e, 0x36, 0xff}}},
    {{{    80,     58,    105}, 0, {  1124,    322}, {0x22, 0x3f, 0x68, 0xff}}},
...
// 0x0801B138
static const Vtx micro_goomba_seg8_vertex_0801B138[] = {
    {{{   156,      0,     74}, 0, { -1340,   -572}, {0x6a, 0x04, 0x45, 0xff}}},
...
// 0x0801B238
static const Vtx micro_goomba_seg8_vertex_0801B238[] = {
    {{{   143,     65,    -68}, 0, {    62,    -70}, {0x4c, 0x49, 0xbb, 0xff}}},
    {{{    80,     98,    -61}, 0, {   108,    346}, {0x19, 0x6a, 0xc1, 0xff}}},
    {{{    82,    110,      0}, 0, {   482,    330}, {0x2d, 0x76, 0xf9, 0xff}}},
    {{{   -51,     49,     53}, 0, { -1544,   1510}, {0x85, 0x1a, 0x10, 0xff}}},
...
const Gfx micro_goomba_seg8_dl_0801B2E8[] = {
    gsSPLightColor(LIGHT_1, 0xffffffff),
    gsSPLightColor(LIGHT_2, 0x7f7f7fff),
    gsSPVertex(micro_goomba_seg8_vertex_0801AD48, 15, 0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801AE38, 16, 0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801AF38, 16, 0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801B038, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801B138, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801B238, 11, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx micro_goomba_seg8_dl_0801B560[] = {
    gsDPPipeSync(),
...
const Gfx micro_goomba_seg8_dl_0801B5A0[] = {
    gsSPDisplayList(micro_goomba_seg8_dl_0801B2E8),
...
const Gfx micro_goomba_seg8_dl_0801B5C8[] = {
    gsSPDisplayList(micro_goomba_seg8_dl_0801B560),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, micro_goomba_seg8_texture_08019D30),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPBranchList(micro_goomba_seg8_dl_0801B5A0),
};

// 0x0801B5F0 - 0x0801B618
const Gfx micro_goomba_seg8_dl_0801B5F0[] = {
    gsSPDisplayList(micro_goomba_seg8_dl_0801B560),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, micro_goomba_seg8_texture_0801A530),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPBranchList(micro_goomba_seg8_dl_0801B5A0),
};
...
#ifdef MICRO_FLOOMBAS
const Gfx micro_floomba_seg8_dl_face[] = {
    gsSPDisplayList(micro_goomba_seg8_dl_0801B560),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, micro_floomba_seg8_texture_face),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPBranchList(micro_goomba_seg8_dl_0801B5A0),
};

const Gfx micro_floomba_seg8_dl_blink[] = {
    gsSPDisplayList(micro_goomba_seg8_dl_0801B560),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, micro_floomba_seg8_texture_blink),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPBranchList(micro_goomba_seg8_dl_0801B5A0),
};
...
// 0x0801B618
static const Vtx micro_goomba_seg8_vertex_0801B618[] = {
...
const Gfx micro_goomba_seg8_dl_0801B658[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, micro_goomba_seg8_texture_08019530),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(micro_goomba_seg8_vertex_0801B618, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSPEndDisplayList(),
};

// 0x0801B690 - 0x0801B700
const Gfx micro_goomba_seg8_dl_0801B690[] = {
    gsDPPipeSync(),
    ...
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(micro_goomba_seg8_dl_0801B658),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
// 0x0801B700
static const Vtx micro_goomba_seg8_vertex_0801B700[] = {
...
// 0x0801B800
static const Vtx micro_goomba_seg8_vertex_0801B800[] = {
...
// 0x0801B8F0
static const Vtx micro_goomba_seg8_vertex_0801B8F0[] = {
    {{{     0,     11,     45}, 0, {     0,      0}, {0xd3, 0xda, 0x6f, 0xff}}},
...
// 0x0801B9D0
static const Vtx micro_goomba_seg8_vertex_0801B9D0[] = {
...
// 0x0801BA50
static const Vtx micro_goomba_seg8_vertex_0801BA50[] = {
...
// 0x0801BB40
static const Vtx micro_goomba_seg8_vertex_0801BB40[] = {
...
// 0x0801BC40
static const Vtx micro_goomba_seg8_vertex_0801BC40[] = {
    {{{    60,    -12,    -44}, 0, {     0,      0}, {0x20, 0xb2, 0xa2, 0xff}}},
...
// 0x0801BD40
static const Vtx micro_goomba_seg8_vertex_0801BD40[] = {
    {{{   -25,      0,    -19}, 0, {     0,      0}, {0xad, 0xa9, 0xda, 0xff}}},
...
// 0x0801BDC0
static const Vtx micro_goomba_seg8_vertex_0801BDC0[] = {
...
// 0x0801BEC0
static const Vtx micro_goomba_seg8_vertex_0801BEC0[] = {
...
// 0x0801BFB0
static const Vtx micro_goomba_seg8_vertex_0801BFB0[] = {
    {{{   -24,   -108,     58}, 0, {     0,      0}, {0xbc, 0x9d, 0x28, 0xff}}},
...
// 0x0801C0A0
static const Vtx micro_goomba_seg8_vertex_0801C0A0[] = {
    {{{   -23,    -55,   -117}, 0, {     0,      0}, {0xba, 0xd3, 0xa1, 0xff}}},
...
// 0x0801C1A0
static const Vtx micro_goomba_seg8_vertex_0801C1A0[] = {
    {{{   142,    -64,     68}, 0, {     0,      0}, {0x4f, 0xb8, 0x43, 0xff}}},
...
// 0x0801C280
static const Vtx micro_goomba_seg8_vertex_0801C280[] = {
    {{{   142,     64,    -68}, 0, {     0,      0}, {0x4d, 0x4b, 0xbe, 0xff}}},
...
// 0x0801C360
static const Vtx micro_goomba_seg8_vertex_0801C360[] = {
    {{{    81,      0,    118}, 0, {     0,      0}, {0x2c, 0x00, 0x77, 0xff}}},
    {{{    -1,      0,    139}, 0, {     0,      0}, {0xed, 0x00, 0x7d, 0x00}}},
    {{{   -23,    -55,    117}, 0, {     0,      0}, {0xba, 0xd3, 0x5f, 0x00}}},
    {{{    79,    -57,    104}, 0, {     0,      0}, {0x21, 0xbf, 0x67, 0xff}}},
...
// 0x0801C460
static const Vtx micro_goomba_seg8_vertex_0801C460[] = {
...
// 0x0801C560
static const Vtx micro_goomba_seg8_vertex_0801C560[] = {
    {{{   -24,    108,     74}, 0, {     0,      0}, {0xbd, 0x62, 0x2a, 0xff}}},
    {{{    -1,    128,      0}, 0, {     0,      0}, {0xf3, 0x7e, 0x00, 0x00}}},
    {{{   -24,    108,    -74}, 0, {     0,      0}, {0xbd, 0x62, 0xd6, 0x00}}},
    {{{   -23,    -55,    117}, 0, {     0,      0}, {0xba, 0xd3, 0x5f, 0xff}}},
...
// 0x0801C620
static const Vtx micro_goomba_seg8_vertex_0801C620[] = {
...
// 0x0801C720
static const Vtx micro_goomba_seg8_vertex_0801C720[] = {
    {{{   -46,     38,     27}, 0, {     0,      0}, {0xa6, 0x48, 0x34, 0xff}}},
...
// 0x0801C810
static const Vtx micro_goomba_seg8_vertex_0801C810[] = {
    {{{    48,    -14,     45}, 0, {     0,      0}, {0x5a, 0xe5, 0x55, 0xff}}},
...
// 0x0801C910
static const Vtx micro_goomba_seg8_vertex_0801C910[] = {
    {{{   -46,    -38,     27}, 0, {     0,      0}, {0xa6, 0xb8, 0x34, 0xff}}},
...
// 0x0801CA00
static const Vtx micro_goomba_seg8_vertex_0801CA00[] = {
    {{{    48,    -38,    -27}, 0, {     0,      0}, {0x5a, 0xb8, 0xcc, 0xff}}},
...
// 0x0801CB00
static const Vtx micro_goomba_seg8_vertex_0801CB00[] = {
    {{{   -46,    -14,    -45}, 0, {     0,      0}, {0xa6, 0xe5, 0xab, 0xff}}},
...
// 0x0801CBF0
static const Vtx micro_goomba_seg8_vertex_0801CBF0[] = {
    {{{    48,     38,    -27}, 0, {     0,      0}, {0x5a, 0x48, 0xcc, 0xff}}},
    {{{    48,     47,      0}, 0, {     0,      0}, {0x5a, 0x59, 0x00, 0x00}}},
...
// 0x0801CCF0
static const Vtx micro_goomba_seg8_vertex_0801CCF0[] = {
    {{{    65,     17,      0}, 0, {     0,      0}, {0x77, 0x2b, 0x00, 0xff}}},
    {{{    65,    -14,     10}, 0, {     0,      0}, {0x77, 0xdd, 0x19, 0x00}}},
...
// 0x0801CDF0
static const Vtx micro_goomba_seg8_vertex_0801CDF0[] = {
    {{{   -63,     17,      0}, 0, {     0,      0}, {0x89, 0x2b, 0x00, 0xff}}},
...
const Gfx micro_goomba_seg8_dl_0801CE20[] = {
    gsSPLightColor(LIGHT_1, 0x542e10ff),
    gsSPLightColor(LIGHT_2, 0x150b04ff),
    gsSPVertex(micro_goomba_seg8_vertex_0801B700, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801B800, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801B8F0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9,  5, 0x0,  8,  5, 10, 0x0),
    gsSP2Triangles(11, 12,  9, 0x0, 11,  9, 13, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801B9D0, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
...
const Gfx micro_goomba_seg8_dl_0801CF78[] = {
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801BD40, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSPEndDisplayList(),
};
...
const Gfx micro_goomba_seg8_dl_0801D0D0[] = {
    gsSPLightColor(LIGHT_1, 0x774220ff),
    gsSPLightColor(LIGHT_2, 0x1d1008ff),
    gsSPVertex(micro_goomba_seg8_vertex_0801BDC0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801BEC0, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 4,  8,  9, 0x0, 10, 11,  7, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801BFB0, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0,  3,  5,  2, 0x0),
    gsSP1Triangle( 3,  2,  1, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C0A0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles( 1, 12, 13, 0x0,  1, 13, 14, 0x0),
    gsSP2Triangles(10, 15, 12, 0x0, 10, 12,  0, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C1A0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  6, 0x0),
    gsSP2Triangles( 7,  8,  9, 0x0,  7,  9, 10, 0x0),
    gsSP2Triangles(11, 12,  8, 0x0, 11,  8, 13, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C280, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  6, 0x0),
    gsSP2Triangles( 7,  8,  9, 0x0,  7,  9, 10, 0x0),
    gsSP2Triangles(11, 12, 13, 0x0, 11, 13,  2, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C360, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles(10,  9, 12, 0x0, 10, 12, 13, 0x0),
    gsSP2Triangles(12,  9, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C460, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 10, 11, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C560, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSPEndDisplayList(),
};
...
const Gfx micro_goomba_seg8_dl_0801D360[] = {
    gsSPLightColor(LIGHT_1, 0xdeb44eff),
    gsSPLightColor(LIGHT_2, 0x372d13ff),
    gsSPVertex(micro_goomba_seg8_vertex_0801C620, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801C720, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  0, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801C810, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  0, 0x0),
    gsSP2Triangles( 6,  7,  5, 0x0,  6,  5,  4, 0x0),
    gsSP2Triangles( 8,  9,  7, 0x0,  8,  7,  6, 0x0),
    ...
    gsSP2Triangles( 5, 14, 12, 0x0,  5, 12,  1, 0x0),
    gsSP2Triangles( 7, 15, 14, 0x0,  7, 14,  5, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801C910, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  0, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  6,  8,  9, 0x0),
    gsSP2Triangles(10, 11,  7, 0x0, 10,  7,  6, 0x0),
    ...
    gsSP2Triangles( 1, 13, 12, 0x0,  1, 12,  2, 0x0),
    gsSP2Triangles( 5, 14, 13, 0x0,  5, 13,  1, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801CA00, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  0, 0x0),
    gsSP2Triangles( 6,  7,  5, 0x0,  6,  5,  4, 0x0),
    gsSP2Triangles( 8,  9,  7, 0x0,  8,  7,  6, 0x0),
    ...
    gsSP2Triangles( 5, 14, 12, 0x0,  5, 12,  1, 0x0),
    gsSP2Triangles( 7, 15, 14, 0x0,  7, 14,  5, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801CB00, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  0, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  6,  8,  9, 0x0),
    gsSP2Triangles(10, 11,  7, 0x0, 10,  7,  6, 0x0),
    ...
    gsSP2Triangles( 1, 13, 12, 0x0,  1, 12,  2, 0x0),
    gsSP2Triangles( 5, 14, 13, 0x0,  5, 13,  1, 0x0),
    gsSPVertex(micro_goomba_seg8_vertex_0801CBF0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  1, 0x0,  4,  1,  0, 0x0),
    gsSP2Triangles( 6,  7,  5, 0x0,  6,  5,  4, 0x0),
    gsSP2Triangles( 8,  9,  7, 0x0,  8,  7,  6, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801CCF0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    ...
    gsSPVertex(micro_goomba_seg8_vertex_0801CDF0, 3, 0),
    gsSP1Triangle( 0,  1,  2, 0x0),
    gsSPEndDisplayList(),
};

// 0x0801D760 - 0x0801D770
const Gfx micro_goomba_seg8_dl_0801D760[] = {
