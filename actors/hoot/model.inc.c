...
gsSPLightColor(LIGHT_2, 0x631e0fff),
gsSPLightColor(LIGHT_3, 0x180703ff),
...
gsSPLightColor(LIGHT_2, 0xfeea26ff),
gsSPLightColor(LIGHT_3, 0x3f3a09ff),
    gsSPVertex(hoot_seg5_vertex_05001310, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
gsSPLightColor(LIGHT_2, 0x4d352eff),
gsSPLightColor(LIGHT_3, 0x130d0bff),
...
gsSPLightColor(LIGHT_2, 0xdb9946ff),
gsSPLightColor(LIGHT_3, 0x362611ff),
...
gsSPLightColor(LIGHT_3, 0x60606ff),
...
gsSPLightColor(LIGHT_2, 0x772a16ff),
gsSPLightColor(LIGHT_3, 0x1d0a05ff),
...
gsSPLightColor(LIGHT_2, 0xc06e3dff),
gsSPLightColor(LIGHT_3, 0x301b0fff),
