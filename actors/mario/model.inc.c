...
gsSPLightColor(LIGHT_2, 0x721c0eff),
gsSPLightColor(LIGHT_3, 0x390e07ff),
...
gsSPLightColor(LIGHT_3, 0x390300ff),
...
const Gfx mario_cap_on_eyes_front[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
gsSPLightColor(LIGHT_2, 0xfec179ff),
gsSPLightColor(LIGHT_3, 0x7f603cff),
