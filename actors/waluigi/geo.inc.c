					...
					GEO_OPEN_NODE(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 240, 0, waluigi_000_offset_mesh_layer_1),
									GEO_OPEN_NODE(),
										GEO_ASM(0, geo_move_mario_part_from_parent),
										GEO_ASM(0, geo_mario_tilt_torso),
										GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
										GEO_OPEN_NODE(),
											GEO_ANIMATED_PART(LAYER_OPAQUE, 56, 0, 0, waluigi_000_offset_001_mesh_layer_1),
											GEO_OPEN_NODE(),
												...
												GEO_OPEN_NODE(),
													...
													GEO_CLOSE_NODE(),
												GEO_CLOSE_NODE(),
												GEO_ANIMATED_PART(LAYER_OPAQUE, 160, -10, 80, NULL),
												GEO_OPEN_NODE(),
													GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, waluigi_000_offset_003_mesh_layer_1),
													GEO_OPEN_NODE(),
														GEO_ANIMATED_PART(LAYER_OPAQUE, 144, 0, 0, waluigi_000_offset_004_mesh_layer_1),
														GEO_OPEN_NODE(),
												...
												GEO_OPEN_NODE(),
													...
													GEO_OPEN_NODE(),
														GEO_ANIMATED_PART(LAYER_OPAQUE, 144, 0, 0, waluigi_000_offset_007_mesh_layer_1),
														GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(LAYER_OPAQUE, 208, 0, 0, waluigi_000_offset_010_mesh_layer_1),
												GEO_OPEN_NODE(),
													GEO_ANIMATED_PART(LAYER_OPAQUE, 192, 0, 0, waluigi_000_offset_011_mesh_layer_1),
												GEO_CLOSE_NODE(),
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_ANIMATED_PART(LAYER_OPAQUE, 13, -8, -42, NULL),
										GEO_OPEN_NODE(),
											...
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(LAYER_OPAQUE, 208, 0, 0, waluigi_000_offset_013_mesh_layer_1),
												GEO_OPEN_NODE(),
													GEO_ANIMATED_PART(LAYER_OPAQUE, 192, 0, 0, NULL),
													GEO_OPEN_NODE(),
