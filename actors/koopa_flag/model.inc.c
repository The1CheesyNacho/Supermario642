...
static const Vtx koopa_flag_seg6_vertex_06000A68[] = {
    {{{     0,      0,    720}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{   460,      0,    540}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,      0,      0}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{   460,      0,   -539}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,      0,   -719}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
};
...
static const Vtx koopa_flag_seg6_vertex_06000D50[] = {
    {{{     0,      0,    224}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{   288,      0,    112}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{   288,      0,   -111}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,      0,   -223}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
};
...
static const Vtx koopa_flag_seg6_vertex_06000DF0[] = {
    {{{     0,      0,    112}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{   288,      0,      0}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
    {{{     0,      0,   -111}, 0, {     0,      0}, {0x00, 0x00, 0x00, 0xff}}},
};
