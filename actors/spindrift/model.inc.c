...
gsSPLightColor(LIGHT_2, 0xddff01ff),
gsSPLightColor(LIGHT_3, 0x373f00ff),
    gsSPVertex(spindrift_seg5_vertex_050000C0, 6, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  2, 0x0),
    gsSP2Triangles( 1,  3,  2, 0x0,  4,  5,  2, 0x0),
    gsSP1Triangle( 5,  0,  2, 0x0),
gsSPLightColor(LIGHT_2, 0x49b200ff),
gsSPLightColor(LIGHT_3, 0x122c00ff),
...
gsSPLightColor(LIGHT_3, 0xf00ff),
...
gsSPLightColor(LIGHT_2, 0xffe200ff),
gsSPLightColor(LIGHT_3, 0x3f3800ff),
