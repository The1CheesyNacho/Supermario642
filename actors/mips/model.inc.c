...
gsSPLightColor(LIGHT_2, 0x27210bff),
gsSPLightColor(LIGHT_3, 0xf0d04ff),
...
const Gfx mips_seg6_dl_06010DB0[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
gsSPLightColor(LIGHT_2, 0x969600ff),
gsSPLightColor(LIGHT_3, 0x3c3c00ff),
...
gsSPLightColor(LIGHT_2, 0x858e00ff),
gsSPLightColor(LIGHT_3, 0x353800ff),
...
gsSPLightColor(LIGHT_2, 0x826e26ff),
gsSPLightColor(LIGHT_3, 0x342c0fff),
