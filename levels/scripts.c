...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_METAL_MARIO,             metal_mario_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YOSHI,                   RCP_HmsEnemyyoshi_base_data),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MICRO_GOOMBA,            micro_goomba_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_GUMMY,                   gummy_geo),
    RETURN(),
};
...
const LevelScript script_func_global_16[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MIPSY,                   mipsy_geo),
