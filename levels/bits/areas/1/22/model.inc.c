...
gsSPLightColor(LIGHT_2, 0xb1bffaff),
gsSPLightColor(LIGHT_3, 0x585f7dff),
    gsSPVertex(bits_seg7_vertex_07012DF8, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 0,  3,  4, 0x0,  0,  5,  6, 0x0),
    gsSP2Triangles( 0,  7,  1, 0x0,  0,  4,  5, 0x0),
gsSPLightColor(LIGHT_2, 0x988cd8ff),
gsSPLightColor(LIGHT_3, 0x4c466cff),
...
gsSPLightColor(LIGHT_2, 0xb265ffff),
gsSPLightColor(LIGHT_3, 0x59327fff),
