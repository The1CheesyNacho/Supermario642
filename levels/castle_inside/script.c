...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_TOAD, 121, -55, 2698, 0, 0, 0, 0x00000000, bhvToadMessage),
		OBJECT(MODEL_NONE, 33, 77, -1442, 0, 0, 0, 0x00000000, bhvToadNpcNode),
		OBJECT(MODEL_NONE, -1127, 807, -1466, 0, 0, 0, 0x00000000, bhvToadNpcNode),
		OBJECT(MODEL_NONE, 2781, 75, -1104, 0, 0, 0, 0x00000000, bhvToadNpcNode),
		OBJECT(MODEL_NONE, 3013, 560, 2078, 0, 0, 0, 0x00000000, bhvToadNpcNode),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 886, 269, -906),
