...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 1, castle_geo_001400),
        ...
        OBJECT(/*model*/ MODEL_TOADSWORTH,       /*pos*/ -1671,    0,  1313, /*angle*/ 0,  83, 0, /*behParam*/ DIALOG_133 << 24, /*beh*/ bhvToadMessage),
    ...
    AREA(/*index*/ 3, castle_geo_001C10),
        ...
        OBJECT(/*model*/ MODEL_MIPSY,                      /*pos*/ -1509, -1177, -1564, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMips),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0001, /*seq*/ SEQ_BASEMENT),
        TERRAIN_TYPE(/*terrainType*/ TERRAIN_STONE),
    END_AREA(),
