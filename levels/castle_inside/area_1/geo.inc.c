...
const GeoLayout castle_inside_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 331, 0, 3025, 90, 0, 90, castle_inside_dl_castle_inside_dl_Inside_Castle_mesh_layer_1_mesh_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
...
const GeoLayout castle_inside_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_BACKGROUND_COLOR(RGBA16(0, 0, 0, 1)),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
