...
static const LevelScript script_func_local_3[] = {
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,                  /*pos*/  2977, 4562, -4788, /*angle*/ 0, -147, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStar,                  /*acts*/ ACT_1),
    OBJECT_WITH_ACTS(/*model*/ MODEL_MIPS_X,      /*pos*/ -4004,    0,  5221, /*angle*/ 0, 0, 0,    /*behParam*/ 0x01050000, /*beh*/ bhvKoopa,                 /*acts*/ ACT_2),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,                  /*pos*/ -5500, 1500,  2300, /*angle*/ 0, 0, 0,    /*behParam*/ 0x05000000, /*beh*/ bhvHiddenRedCoinStar,     /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,                  /*pos*/ -600, 4400,  600, /*angle*/ 0, 0, 0,    /*behParam*/ 0x04040000, /*beh*/ bhvHiddenStar,              /*acts*/ ALL_ACTS),
	OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,                  /*pos*/  5500, 3400,   1200, /*angle*/ 0, 0, 0,    /*behParam*/ 0x03000000, /*beh*/ bhvStar,                 /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,                  /*pos*/  1550, 1200,   300, /*angle*/ 0, 0, 0,    /*behParam*/ 0x02000000, /*beh*/ bhvStar,                  /*acts*/ ALL_ACTS),
    RETURN(),
};
...
const LevelScript level_bob_entry[] = {
    ...
    MARIO(/*model*/ MODEL_MARIO, /*behParam*/ 0x00000001, /*beh*/ bhvLuigi),
