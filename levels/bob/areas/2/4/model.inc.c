...
static const Vtx bob_2_seg7_vertex_0700A4E0[] = {
...
static const Vtx bob_2_seg7_vertex_0700A560[] = {
...
static const Vtx bob_2_seg7_vertex_0700A650[] = {
...
static const Vtx bob_2_seg7_vertex_0700A740[] = {
...
static const Gfx bob_2_seg7_dl_0700A800[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, generic_09008800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(bob_2_seg7_vertex_0700A4E0, 8, 0),
...
static const Gfx bob_2_seg7_dl_0700A848[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bob_seg7_texture_07000000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(bob_2_seg7_vertex_0700A560, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  6,  4, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles( 7, 10,  8, 0x0, 11, 12, 13, 0x0),
    gsSP1Triangle(14, 11, 13, 0x0),
    gsSPVertex(bob_2_seg7_vertex_0700A650, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  6,  8,  9, 0x0),
    gsSP2Triangles(10, 11, 12, 0x0, 10, 12, 13, 0x0),
    gsSP1Triangle(14,  0,  2, 0x0),
    gsSPVertex(bob_2_seg7_vertex_0700A740, 12, 0),
...
const Gfx bob_2_seg7_dl_0700A920[] = {
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetDepthSource(G_ZS_PIXEL),
    gsDPSetFogColor(255, 80, 0, 255),
    ...
    gsSPDisplayList(bob_2_seg7_dl_0700A800),
    gsSPDisplayList(bob_2_seg7_dl_0700A848),
