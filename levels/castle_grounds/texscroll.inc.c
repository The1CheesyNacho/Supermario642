void scroll_castle_grounds_dl_mesh1_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 9;
	int height = 32 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_mesh1_mesh_layer_5_vtx_0);
...
void scroll_castle_grounds() {
	scroll_castle_grounds_dl_mesh1_mesh_layer_5_vtx_0();
