...
gsSPLightColor(LIGHT_3, 0x363637ff),
...
static const Gfx castle_grounds_seg7_dl_07008EE8[] = {
    ...
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  1, 0x0),
gsSPLightColor(LIGHT_2, 0x72728cff),
gsSPLightColor(LIGHT_3, 0x2d2d38ff),
...
gsSPLightColor(LIGHT_2, 0x676769ff),
gsSPLightColor(LIGHT_3, 0x29292aff),
...
gsSPLightColor(LIGHT_2, 0xd8d8d8ff),
gsSPLightColor(LIGHT_3, 0x565656ff),
...
gsSPLightColor(LIGHT_2, 0x585862ff),
gsSPLightColor(LIGHT_3, 0x232327ff),
...
static const Gfx castle_grounds_seg7_dl_07009330[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
gsSPLightColor(LIGHT_2, 0x30db02ff),
gsSPLightColor(LIGHT_3, 0x135700ff),
