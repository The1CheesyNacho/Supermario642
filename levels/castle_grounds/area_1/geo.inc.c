...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 2773, 2412, 4206, castle_grounds_dl_castle_grounds_seg7_dl_0700A290_mesh_001_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_castle_grounds_seg7_dl_0700A290_mesh_001_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_castle_grounds_seg7_dl_0700A290_mesh_001_mesh_layer_4),
		GEO_CLOSE_NODE(),
