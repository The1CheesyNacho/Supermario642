...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4731, 868, 8031, 0, 171, 0, castle_grounds_dl_mah_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_mah_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_grounds_dl_mah_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 58, -365, 105, castle_grounds_dl_Water_Box_Mesh_mesh_layer_5),
