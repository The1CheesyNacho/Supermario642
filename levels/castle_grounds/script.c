...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_TOAD, -4580, 755, 6980, 0, 133, 0, 0x00010000, bhvToadMessage),
		OBJECT(MODEL_NONE, -4580, 755, 6980, 0, 0, 0, 0x00010000, bhvToadNpcNode),
		OBJECT(MODEL_NONE, -4780, 755, 6980, 0, 0, 0, 0x00010000, bhvToadNpcNode),
		OBJECT(MODEL_NONE, -4780, 755, 7180, 0, 0, 0, 0x00010000, bhvToadNpcNode),
		OBJECT(MODEL_TOAD, -5296, 755, 5340, 0, 95, 0, 0x000A0000, bhvToadMessage),
		OBJECT(MODEL_TOAD, -5168, 755, 3543, 0, 56, 0, 0x000A0000, bhvToadMessage),
		OBJECT(MODEL_TOAD, -4287, 755, 2527, 0, 30, 0, 0x000A0000, bhvToadMessage),
		OBJECT(MODEL_WOODEN_SIGNPOST, -2862, 755, 2271, 0, 10, 0, 0x000A0000, bhvMessagePanel),
		OBJECT(MODEL_TOAD, 1212, -23, 7258, 0, 129, 0, 0x000A0000, bhvToadMessage),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, -1298, 1656, -2919, 0, 180, 0,   0x00010000, bhvDoorWarp),
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, -1452, 1656, -2919, 0, 0, 0,   0x00000000, bhvDoorWarp),
