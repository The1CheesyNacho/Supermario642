...
gsSPLightColor(LIGHT_2, 0xc8c8c8ff),
gsSPLightColor(LIGHT_3, 0x323232ff),
...
static const Gfx rr_seg7_dl_0701A3E0[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
gsSPLightColor(LIGHT_2, 0x8eac52ff),
gsSPLightColor(LIGHT_3, 0x232b14ff),
    gsSPVertex(rr_seg7_vertex_07019EC0, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  7,  5, 0x0),
gsSPLightColor(LIGHT_2, 0x7fac52ff),
gsSPLightColor(LIGHT_3, 0x1f2b14ff),
...
gsSPLightColor(LIGHT_3, 0x2f2a0fff),
...
gsSPLightColor(LIGHT_2, 0x528eacff),
gsSPLightColor(LIGHT_3, 0x14232bff),
