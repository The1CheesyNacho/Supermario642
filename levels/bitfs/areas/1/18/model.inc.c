...
gsSPLightColor(LIGHT_3, 0x646464ff),
...
static const Gfx bitfs_seg7_dl_0700E530[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
gsSPLightColor(LIGHT_2, 0xc4ffffff),
gsSPLightColor(LIGHT_3, 0x627f7fff),
...
gsSPLightColor(LIGHT_2, 0x65ffb2ff),
gsSPLightColor(LIGHT_3, 0x327f59ff),
