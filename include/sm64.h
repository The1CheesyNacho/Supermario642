...
/*collision defines*/
// how much objects/mario can snap upwards in the floor search function
#define FLOOR_SNAP_OFFSET 78
// how much velocity mario needs to bonk off of walls. (also decides ceiling bonks)
#define WALLKICK_MIN_VEL 16.f
...
#define GROUND_STEP_HIT_WALL_CONTINUE_QSTEPS STEP_HIT_CEILING
 
#define AIR_STEP_CHECK_LEDGE_GRAB STEP_CHECK_LEDGE_GRAB
#define AIR_STEP_CHECK_HANG STEP_CHECK_HANG
#define AIR_STEP_NO_GRAVITY STEP_NO_GRAVITY
 
#define AIR_STEP_CHECK_NONE STEP_NO_GRAVITY
...
#define AIR_STEP_HIT_CEILING STEP_HIT_CEILING
 
#define STEP_IN_AIR 0
#define STEP_ON_GROUND 1
#define STEP_HIT_WALL 2
#define STEP_GRAB_LEDGE 3
#define STEP_GRAB_CEILING 4
#define STEP_HIT_LAVA 5
#define STEP_HIT_CEILING 6
...
enum MarioFlags {
    ...
    MARIO_SPECIAL_CAPS        = (MARIO_VANISH_CAP | MARIO_METAL_CAP | MARIO_WING_CAP | MARIO_GOLD_CAP),
...
#define ACT_CHARGE                     0x00000041 // (0x041)
