...
static struct SpecialPreset SpecialObjectPresets[] = {
    ...
    { 0x03, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                        , bhvStaticObject                  },
    { 0x04, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_BOO                               , bhvCourtyardBooTriplet           },
    { 0x05, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                        , bhvCastleFloorTrap               },
    { 0x06, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE, NULL},
    { 0x07, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                  , bhvSnowBall                      },
    { 0x08, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE               , NULL          },
    { 0x09, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                              , bhvStaticObject                  },
    { 0x0A, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE      , NULL  },
    { 0x0B, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                              , NULL         },
    { 0x0C, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                              , NULL             },
    { 0x0D, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE       , NULL      },
    { 0x0E, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE  , NULL },
    { 0x0F, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE      , NULL     },
    { 0x10, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE       , NULL     },
    { 0x11, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                              , NULL               },
    ...
    { 0x1C, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_WATER_RING                        , NULL          },
    ...
    { 0x22, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE       , NULL      },
    { 0x23, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE                     , NULL                     },
    { 0x24, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE               , NULL             },
    { 0x25, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                              , NULL            },
    { 0x26, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                              , NULL      },
    { 0x27, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                , NULL              },
    { 0x28, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                     , NULL                     },
    ...
    { 0x79, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_BUBBLY_TREE                       , bhvTree                          },
    { 0x7A, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_COURTYARD_SPIKY_TREE              , bhvTree                          },
    { 0x7B, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                     , bhvTree                          },
    { 0x7C, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_NONE                   , bhvTree                          },
    { 0x7D, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_SSL_PALM_TREE                     , bhvTree                          },
    { 0x89, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE         , bhvDoor                          },
    { 0x7E, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_CASTLE_WOODEN_DOOR_UNUSED         , bhvDoor                          },
    { 0x7F, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE                   , bhvDoor                          },
    { 0x80, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE                    , bhvDoor                          },
    { 0x81, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE                , bhvDoor                          },
    { 0x82, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_NONE                   , bhvDoor                          },
    ...
    { 0x84, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_NONE                   , bhvDoorWarp                      },
    { 0x85, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_CASTLE_METAL_DOOR                 , bhvDoorWarp                      },
    { 0x86, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_NONE                   , bhvDoorWarp                      },
    { 0x87, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_NONE                   , bhvDoorWarp                      },
