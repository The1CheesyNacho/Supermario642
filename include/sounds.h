...
// A random number 0-2 is added to the sound ID before playing
#define SOUND_LUIGI_PANTING                     SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x18, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_LUIGI_COUGHING1                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_COUGHING2                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_COUGHING3                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_YAH                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_HOO                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_MAMA_MIA                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x20, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_OKEY_DOKEY                  SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x21, 0x00, 0) // unused
#define SOUND_LUIGI_GROUND_POUND_WAH            SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x22, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_DROWNING                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x23, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PUNCH_WAH                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x24, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-4 is added to the sound ID before playing, producing one of
// Yahoo! (60% chance), Waha! (20%), or Yippee! (20%).
#define SOUND_LUIGI_YAHOO_WAHA_YIPPEE           SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x2B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_LUIGI_DOH                         SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x30, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_GAME_OVER                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x31, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_HELLO                       SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x32, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_PRESS_START_TO_PLAY         SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x33, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
#define SOUND_LUIGI_TWIRL_BOUNCE                SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x34, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SNORING3                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x35, 0x00, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_SO_LONGA_BOWSER             SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x36, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_LUIGI_IMA_TIRED                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x37, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
// A random number 0-2 is added to the sound ID before playing
#define SOUND_WARIO_PANTING                     SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x18, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_WARIO_COUGHING1                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_COUGHING2                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_COUGHING3                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_PUNCH_YAH                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_PUNCH_HOO                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_MAMA_MIA                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x20, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_OKEY_DOKEY                  SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x21, 0x00, 0) // unused
#define SOUND_WARIO_GROUND_POUND_WAH            SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x22, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_DROWNING                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x23, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_PUNCH_WAH                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x24, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-4 is added to the sound ID before playing, producing one of
// Yahoo! (60% chance), Waha! (20%), or Yippee! (20%).
#define SOUND_WARIO_YAHOO_WAHA_YIPPEE           SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x2B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_WARIO_DOH                         SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x30, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_GAME_OVER                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x31, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_HELLO                       SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x32, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_PRESS_START_TO_PLAY         SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x33, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
#define SOUND_WARIO_TWIRL_BOUNCE                SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x34, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_SNORING3                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x35, 0x00, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_SO_LONGA_BOWSER             SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x36, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WARIO_IMA_TIRED                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x37, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
// A random number 0-2 is added to the sound ID before playing
#define SOUND_WALUIGI_PANTING                     SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x18, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_WALUIGI_COUGHING1                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_COUGHING2                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_COUGHING3                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_PUNCH_YAH                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1E, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_PUNCH_HOO                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x1F, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_MAMA_MIA                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x20, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_OKEY_DOKEY                  SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x21, 0x00, 0) // unused
#define SOUND_WALUIGI_GROUND_POUND_WAH            SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x22, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_DROWNING                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x23, 0xF0, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_PUNCH_WAH                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x24, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

// A random number 0-4 is added to the sound ID before playing, producing one of
// Yahoo! (60% chance), Waha! (20%), or Yippee! (20%).
#define SOUND_WALUIGI_YAHOO_WAHA_YIPPEE           SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x2B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_WALUIGI_DOH                         SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x30, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_GAME_OVER                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x31, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_HELLO                       SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x32, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_PRESS_START_TO_PLAY         SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x33, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_NO_ECHO | SOUND_DISCRETE)
#define SOUND_WALUIGI_TWIRL_BOUNCE                SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x34, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_SNORING3                    SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x35, 0x00, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_SO_LONGA_BOWSER             SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x36, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WALUIGI_IMA_TIRED                   SOUND_ARG_LOAD(SOUND_BANK_VOICE, 0x37, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
