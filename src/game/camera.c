...
void cutscene_intro_peach_play_message_music(void) {
    //play_music(SEQ_PLAYER_LEVEL, SEQUENCE_ARGS(4, NULL), 0);
}
...
void cutscene_intro_peach_play_lakitu_flying_music(void) {
    //play_music(SEQ_PLAYER_LEVEL, SEQUENCE_ARGS(15, NULL), 0);
}
...
struct CameraTrigger sCamCourse1[] = {
	NULL_TRIGGER
};
struct CameraTrigger sCamCourse0[] = {
	NULL_TRIGGER
};
