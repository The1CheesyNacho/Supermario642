...
static u32 betterReverbSfx[] = {
    REVERB_TOP_PRIO(SOUND_LUIGI_YAH_WAH_HOO),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAH_WAH_HOO + (1 << 16)),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAH_WAH_HOO + (2 << 16)),
    REVERB_TOP_PRIO(SOUND_LUIGI_HOOHOO),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAHOO),
    REVERB_TOP_PRIO(SOUND_LUIGI_UH),
    REVERB_TOP_PRIO(SOUND_LUIGI_HRMM),
    REVERB_TOP_PRIO(SOUND_LUIGI_WAH2),
    REVERB_TOP_PRIO(SOUND_LUIGI_WHOA),
    REVERB_TOP_PRIO(SOUND_LUIGI_EEUH),
    REVERB_TOP_PRIO(SOUND_LUIGI_ATTACKED),
    REVERB_TOP_PRIO(SOUND_LUIGI_OOOF),
    REVERB_TOP_PRIO(SOUND_LUIGI_HERE_WE_GO),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAWNING),
    REVERB_TOP_PRIO(SOUND_LUIGI_WAAAOOOW),
    REVERB_TOP_PRIO(SOUND_LUIGI_HAHA),
    REVERB_TOP_PRIO(SOUND_LUIGI_UH_LEDGE_CLIMB_FAST),
    REVERB_TOP_PRIO(SOUND_LUIGI_ON_FIRE),
    REVERB_TOP_PRIO(SOUND_LUIGI_DYING),
    REVERB_TOP_PRIO(SOUND_LUIGI_PANTING_COLD),
    REVERB_TOP_PRIO(SOUND_LUIGI_PANTING),
    REVERB_TOP_PRIO(SOUND_LUIGI_MAMA_MIA),
    REVERB_TOP_PRIO(SOUND_LUIGI_DROWNING),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAHOO_WAHA_YIPPEE),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAHOO_WAHA_YIPPEE + (3 << 16)),
    REVERB_TOP_PRIO(SOUND_LUIGI_YAHOO_WAHA_YIPPEE + (4 << 16)),
    REVERB_TOP_PRIO(SOUND_LUIGI_DOH),
    REVERB_TOP_PRIO(SOUND_LUIGI_GAME_OVER),
    REVERB_TOP_PRIO(SOUND_LUIGI_HELLO),
    REVERB_TOP_PRIO(SOUND_LUIGI_PRESS_START_TO_PLAY),
    REVERB_TOP_PRIO(SOUND_LUIGI_TWIRL_BOUNCE),
    REVERB_TOP_PRIO(SOUND_LUIGI_SO_LONGA_BOWSER),
    REVERB_TOP_PRIO(SOUND_LUIGI_IMA_TIRED),
};
