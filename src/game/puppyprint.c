...
static u32 betterReverbSfx[] = {
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAH_WAH_HOO),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAH_WAH_HOO + (1 << 16)),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAH_WAH_HOO + (2 << 16)),
    REVERB_TOP_PRIO(SOUND_CHARACTER_HOOHOO),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAHOO),
    REVERB_TOP_PRIO(SOUND_CHARACTER_UH),
    REVERB_TOP_PRIO(SOUND_CHARACTER_HRMM),
    REVERB_TOP_PRIO(SOUND_CHARACTER_WAH2),
    REVERB_TOP_PRIO(SOUND_CHARACTER_WHOA),
    REVERB_TOP_PRIO(SOUND_CHARACTER_EEUH),
    REVERB_TOP_PRIO(SOUND_CHARACTER_ATTACKED),
    REVERB_TOP_PRIO(SOUND_CHARACTER_OOOF),
    REVERB_TOP_PRIO(SOUND_CHARACTER_HERE_WE_GO),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAWNING),
    REVERB_TOP_PRIO(SOUND_CHARACTER_WAAAOOOW),
    REVERB_TOP_PRIO(SOUND_CHARACTER_HAHA),
    REVERB_TOP_PRIO(SOUND_CHARACTER_UH_LEDGE_CLIMB_FAST),
    REVERB_TOP_PRIO(SOUND_CHARACTER_ON_FIRE),
    REVERB_TOP_PRIO(SOUND_CHARACTER_DYING),
    REVERB_TOP_PRIO(SOUND_CHARACTER_PANTING_COLD),
    REVERB_TOP_PRIO(SOUND_CHARACTER_PANTING),
    REVERB_TOP_PRIO(SOUND_CHARACTER_MAMA_MIA),
    REVERB_TOP_PRIO(SOUND_CHARACTER_DROWNING),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAHOO_WAHA_YIPPEE),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAHOO_WAHA_YIPPEE + (3 << 16)),
    REVERB_TOP_PRIO(SOUND_CHARACTER_YAHOO_WAHA_YIPPEE + (4 << 16)),
    REVERB_TOP_PRIO(SOUND_CHARACTER_DOH),
    REVERB_TOP_PRIO(SOUND_CHARACTER_GAME_OVER),
    REVERB_TOP_PRIO(SOUND_CHARACTER_HELLO),
    REVERB_TOP_PRIO(SOUND_CHARACTER_PRESS_START_TO_PLAY),
    REVERB_TOP_PRIO(SOUND_CHARACTER_TWIRL_BOUNCE),
    REVERB_TOP_PRIO(SOUND_CHARACTER_SO_LONGA_BOWSER),
    REVERB_TOP_PRIO(SOUND_CHARACTER_IMA_TIRED),
};
