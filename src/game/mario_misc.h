...
Gfx *geo_set_player_mario(s32 callContext, struct GraphNode *node, UNUSED Mat4 *mtx);
Gfx *geo_set_player_luigi(s32 callContext, struct GraphNode *node, UNUSED Mat4 *mtx);
Gfx *geo_set_player_wario(s32 callContext, struct GraphNode *node, UNUSED Mat4 *mtx);
Gfx *geo_set_player_waluigi(s32 callContext, struct GraphNode *node, UNUSED Mat4 *mtx);
Gfx *geo_set_player_metal_mario(s32 callContext, struct GraphNode *node, UNUSED Mat4 *mtx);
