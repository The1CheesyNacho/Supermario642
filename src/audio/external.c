...
void set_character_sound() {
    ...
    if (cur_obj_has_model(MODEL_WARIO) ) {
        SOUND_CHARACTER_YAH_WAH_HOO = SOUND_WALUIGI_YAH_WAH_HOO;
        SOUND_CHARACTER_HOOHOO = SOUND_WARIO_HOOHOO;
        SOUND_CHARACTER_YAHOO = SOUND_WARIO_YAHOO;
        SOUND_CHARACTER_UH = SOUND_WARIO_UH;
        SOUND_CHARACTER_HRMM = SOUND_WARIO_HRMM;
        SOUND_CHARACTER_WAH2 = SOUND_WARIO_WAH2;
        SOUND_CHARACTER_WHOA = SOUND_WARIO_WHOA;
        SOUND_CHARACTER_EEUH = SOUND_WARIO_EEUH;
        SOUND_CHARACTER_ATTACKED = SOUND_WARIO_ATTACKED;
        SOUND_CHARACTER_OOOF = SOUND_WARIO_OOOF;
        SOUND_CHARACTER_OOOF2 = SOUND_WARIO_OOOF2;
        SOUND_CHARACTER_HERE_WE_GO = SOUND_WARIO_HERE_WE_GO;
        SOUND_CHARACTER_YAWNING = SOUND_WARIO_YAWNING;
        SOUND_CHARACTER_SNORING1 = SOUND_WARIO_SNORING1;
        SOUND_CHARACTER_SNORING2 = SOUND_WARIO_SNORING2;
        SOUND_CHARACTER_WAAAOOOW = SOUND_WARIO_WAAAOOOW;
        SOUND_CHARACTER_HAHA = SOUND_WARIO_HAHA;
        SOUND_CHARACTER_HAHA_WATER = SOUND_WARIO_HAHA_WATER;
        SOUND_CHARACTER_UH_LEDGE_CLIMB_FAST = SOUND_WARIO_UH_LEDGE_CLIMB_FAST;
        SOUND_CHARACTER_UH_LONG_JUMP_LAND = SOUND_WARIO_UH_LONG_JUMP_LAND;
        SOUND_CHARACTER_ON_FIRE = SOUND_WARIO_ON_FIRE;
        SOUND_CHARACTER_DYING = SOUND_WARIO_DYING;
        SOUND_CHARACTER_PANTING_COLD = SOUND_WARIO_PANTING_COLD;
        SOUND_CHARACTER_PANTING = SOUND_WARIO_PANTING;
        SOUND_CHARACTER_COUGHING1 = SOUND_WARIO_COUGHING1;
        SOUND_CHARACTER_COUGHING2 = SOUND_WARIO_COUGHING2;
        SOUND_CHARACTER_COUGHING3 = SOUND_WARIO_COUGHING3;
        SOUND_CHARACTER_PUNCH_YAH = SOUND_WARIO_PUNCH_YAH;
        SOUND_CHARACTER_PUNCH_HOO = SOUND_WARIO_PUNCH_HOO;
        SOUND_CHARACTER_MAMA_MIA = SOUND_WARIO_MAMA_MIA;
        SOUND_CHARACTER_OKEY_DOKEY = SOUND_WARIO_OKEY_DOKEY;
        SOUND_CHARACTER_GROUND_POUND_WAH = SOUND_WARIO_GROUND_POUND_WAH;
        SOUND_CHARACTER_DROWNING = SOUND_WARIO_DROWNING;
        SOUND_CHARACTER_PUNCH_WAH = SOUND_WARIO_PUNCH_WAH;
        SOUND_CHARACTER_YAHOO_WAHA_YIPPEE = SOUND_WARIO_YAHOO_WAHA_YIPPEE;
        SOUND_CHARACTER_DOH = SOUND_WARIO_DOH;
        SOUND_CHARACTER_GAME_OVER = SOUND_WARIO_GAME_OVER;
        SOUND_CHARACTER_HELLO = SOUND_WARIO_HELLO;
        SOUND_CHARACTER_PRESS_START_TO_PLAY = SOUND_WARIO_PRESS_START_TO_PLAY;
        SOUND_CHARACTER_TWIRL_BOUNCE = SOUND_WARIO_TWIRL_BOUNCE;
        SOUND_CHARACTER_SNORING3 = SOUND_WARIO_SNORING3;
        SOUND_CHARACTER_SO_LONGA_BOWSER = SOUND_WARIO_SO_LONGA_BOWSER;
        SOUND_CHARACTER_IMA_TIRED = SOUND_WARIO_IMA_TIRED;
    }
    if (cur_obj_has_model(MODEL_WALUIGI) ) {
        SOUND_CHARACTER_YAH_WAH_HOO = SOUND_WALUIGI_YAH_WAH_HOO;
        SOUND_CHARACTER_HOOHOO = SOUND_WALUIGI_HOOHOO;
        SOUND_CHARACTER_YAHOO = SOUND_WALUIGI_YAHOO;
        SOUND_CHARACTER_UH = SOUND_WALUIGI_UH;
        SOUND_CHARACTER_HRMM = SOUND_WALUIGI_HRMM;
        SOUND_CHARACTER_WAH2 = SOUND_WALUIGI_WAH2;
        SOUND_CHARACTER_WHOA = SOUND_WALUIGI_WHOA;
        SOUND_CHARACTER_EEUH = SOUND_WALUIGI_EEUH;
        SOUND_CHARACTER_ATTACKED = SOUND_WALUIGI_ATTACKED;
        SOUND_CHARACTER_OOOF = SOUND_WALUIGI_OOOF;
        SOUND_CHARACTER_OOOF2 = SOUND_WALUIGI_OOOF2;
        SOUND_CHARACTER_HERE_WE_GO = SOUND_WALUIGI_HERE_WE_GO;
        SOUND_CHARACTER_YAWNING = SOUND_WALUIGI_YAWNING;
        SOUND_CHARACTER_SNORING1 = SOUND_WALUIGI_SNORING1;
        SOUND_CHARACTER_SNORING2 = SOUND_WALUIGI_SNORING2;
        SOUND_CHARACTER_WAAAOOOW = SOUND_WALUIGI_WAAAOOOW;
        SOUND_CHARACTER_HAHA = SOUND_WALUIGI_HAHA;
        SOUND_CHARACTER_HAHA_WATER = SOUND_WALUIGI_HAHA_WATER;
        SOUND_CHARACTER_UH_LEDGE_CLIMB_FAST = SOUND_WALUIGI_UH_LEDGE_CLIMB_FAST;
        SOUND_CHARACTER_UH_LONG_JUMP_LAND = SOUND_WALUIGI_UH_LONG_JUMP_LAND;
        SOUND_CHARACTER_ON_FIRE = SOUND_WALUIGI_ON_FIRE;
        SOUND_CHARACTER_DYING = SOUND_WALUIGI_DYING;
        SOUND_CHARACTER_PANTING_COLD = SOUND_WALUIGI_PANTING_COLD;
        SOUND_CHARACTER_PANTING = SOUND_WALUIGI_PANTING;
        SOUND_CHARACTER_COUGHING1 = SOUND_WALUIGI_COUGHING1;
        SOUND_CHARACTER_COUGHING2 = SOUND_WALUIGI_COUGHING2;
        SOUND_CHARACTER_COUGHING3 = SOUND_WALUIGI_COUGHING3;
        SOUND_CHARACTER_PUNCH_YAH = SOUND_WALUIGI_PUNCH_YAH;
        SOUND_CHARACTER_PUNCH_HOO = SOUND_WALUIGI_PUNCH_HOO;
        SOUND_CHARACTER_MAMA_MIA = SOUND_WALUIGI_MAMA_MIA;
        SOUND_CHARACTER_OKEY_DOKEY = SOUND_WALUIGI_OKEY_DOKEY;
        SOUND_CHARACTER_GROUND_POUND_WAH = SOUND_WALUIGI_GROUND_POUND_WAH;
        SOUND_CHARACTER_DROWNING = SOUND_WALUIGI_DROWNING;
        SOUND_CHARACTER_PUNCH_WAH = SOUND_WALUIGI_PUNCH_WAH;
        SOUND_CHARACTER_YAHOO_WAHA_YIPPEE = SOUND_WALUIGI_YAHOO_WAHA_YIPPEE;
        SOUND_CHARACTER_DOH = SOUND_WALUIGI_DOH;
        SOUND_CHARACTER_GAME_OVER = SOUND_WALUIGI_GAME_OVER;
        SOUND_CHARACTER_HELLO = SOUND_WALUIGI_HELLO;
        SOUND_CHARACTER_PRESS_START_TO_PLAY = SOUND_WALUIGI_PRESS_START_TO_PLAY;
        SOUND_CHARACTER_TWIRL_BOUNCE = SOUND_WALUIGI_TWIRL_BOUNCE;
        SOUND_CHARACTER_SNORING3 = SOUND_WALUIGI_SNORING3;
